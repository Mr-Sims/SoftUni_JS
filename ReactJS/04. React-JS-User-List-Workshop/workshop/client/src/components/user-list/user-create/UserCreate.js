...
export const UserCreate = ({
    ...
    const isPositive = (e) => {
        setErrors(state => ({
            ...state,
            [e.target.name]: Number(values.streetNumber) <= 0
        }));
    }

    let isDisabledError = Object.values(errors).some(x => x);
    let isDisabledEmpty = Object.values(values).some(x => x = '');
            ...
            <div className="modal">
                <div className="user-container">
                    ...
                    <form onSubmit={submitHandler}>
                        ...
                        <div id="form-actions">
                            <button id="action-save" className="btn" type="submit" disabled={isDisabledError || !isDisabledEmpty}>Create</button>
